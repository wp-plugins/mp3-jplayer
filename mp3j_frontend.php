			...
			<div class="wrap">
				<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
					...
					<div id="fox_help1-list" style="display:none;margin:15px 0px 30px 0px; border-bottom:1px solid #ddd;">
								<h5 class="description" style="margin: 10px 120px 20px 0px;">Add players using<code>[mp3j]</code> <code>[mp3t]</code> <code>[mp3-jplayer]</code> <code>[mp3-link]</code> shortcodes and/or <a href="widgets.php">widgets</a>.</h5>
								<p class="description" style="margin: 10px 120px 10px 10px;">Use these instead of a filename to playlist folders or the library:</p>
								<p class="description" style="margin: 10px 120px 20px 10px;"><code>FEED:LIB</code> - Play entire library<br /><code>FEED:DF</code> - Play the default folder (this will only work if your default folder setting is local)<br /><code>FEED:/mymusic</code> - Play the local folder 'mymusic' (folder paths must be local and are relative to the root of your site, NOT the Wordpress install)</p>
								...
								<div style="margin:0px 0px 0px 15px;">
									...
									<p class="description" style="margin: 0px 120px 20px 10px;">
										<code>track</code> filename or URI<br /><code>caption</code> caption text<br /><code>vol</code> 0 - 100<br /><code>autoplay</code> y/n<br /><code>loop</code> y/n, repeat play track (overides subsequent autoplay players)<br />
										<code>title</code> replaces default title and caption<br /><code>bold</code> y/n, bold font<br /><code>flip</code> y/n, move play/pause button to other side<br /><code>ind</code> y/n, hide indicator and time<br /><code>flow</code> y/n, set to 'y' to put players within paragraphs without line-breaking (works for line heights around 22px)</p>
								...
								<p class="description" style="margin: 0px 120px 6px 10px;">1. Enter <code>mp3</code> into the left hand box.<br />2. Write the filename/URI into the right hand box and hit 'add custom field'</p>
