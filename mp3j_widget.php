		...
		*/
			function MP3_jPlayer() {
				...
				$widget_ops = array( 
					...
					'description' => __('Add playlist players by choosing the playback mode, ticking some boxes and maybe writing a playlist.', 
					'mp3jplayerwidget') 
				);
				$control_ops = array( 
		...
		*/						
			function form( $instance ) {
				...
				?>
					...
					<p class="description" style="font-size:11px; margin-top:4px; margin-bottom:1px; <?php echo $helptext_col; ?>">A comma separated list, can use post ID's, <code>index</code>, and <code>archive</code>.</p> 
			...
			function form( $instance ) {
				...
				?>
					...
					<p style="font-size: 11px; margin:10px 0px 4px 0px;">
						...
						Exclude pages &nbsp;<input class="widefat" style="font-size:11px; width:200px;" type="text" id="<?php echo $this->get_field_id( 'restrict_list' ); ?>" name="<?php echo $this->get_field_name( 'restrict_list' ); ?>" value="<?php echo $instance['restrict_list']; ?>" /></p>
					<p class="description" style="font-size:11px; color:#999999; margin-top:4px; margin-bottom:1px;">A comma separated list, can use post ID's, <code>index</code>, and <code>archive</code>.</p> 
					<!-- Widget Heading -->
